...
Today, I/V curves are recored by means of a phase senstive detection device, such as a lock-in amplifier. Depending on the correct usage of the lock-in amplifier, this allows to filter the I/V, dI/dV and d<sup>2</sup>I/dV<sup>2 signal and to approximatelly measure the dI/dV and d<sup>2</sup>I/dV<sup>2</sup> data. 
